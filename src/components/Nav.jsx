...
function Nav() {
  ...
  return (
      ...
      <nav className="bg-blue-100 text-slate-900 rounded-lg shadow-xl ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <span className="font-bold text-3xl shadow-zinc-800">TriUnity</span>
            </div>
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline  space-x-4">
              <a href="#services" className="px-3 py-2 text-xl rounded-md  font-medium hover:bg-yellow-00">
                  Services
                </a>
                <a href="#about" className="px-3 py-2 rounded-md text-xl font-medium hover:bg-yellow-00">
                  About
                </a>
               
                <a href="#contact" className="px-3 py-2 rounded-md text-xl font-medium hover:bg-yellow-200">
                  Contact
                </a>
              </div>
            </div>
